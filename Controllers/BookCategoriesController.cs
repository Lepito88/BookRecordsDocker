...
namespace BookRecords.Controllers
{
    ...
    public class BookCategoriesController : ControllerBase
    {
        ...
        public BookCategoriesController(BookRecordsContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<BookCategory>> PostBookCategory(BookCategory bookCategory)
        {
            ...
            {
                if (BookCategoryExists(bookCategory.Idbook))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetBookCategory", new { id = bookCategory.Idbook }, bookCategory);
        }
        ...
        {
            return _context.BookCategories.Any(e => e.Idbook == id);
        }
    }
}
